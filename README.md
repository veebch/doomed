...
The default index that this code visualises is the Fear and Greed Bitcoin index. It can easily be adapted to pretty much any single index that can be generated by the computer via web scraping or other means (eg. how long since a plant was watered, hard disk space remaining, unread mail count etc etc)
